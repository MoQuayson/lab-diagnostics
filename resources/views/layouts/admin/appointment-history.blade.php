...
<head>
    ...
    <title>Appointment History || Lab Diagnostics</title>
        ...
        <div class="container-fluid">
            ...
            <ul class="nav align-content-between">
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="user_dropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                      {{Auth::user()->name}}
                    </a>
        ...
        <div class="row">
          ...
          <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                ...
                <a href="#" role="button" class="btn btn-outline-primary" data-bs-target="#NewAppointment" data-bs-toggle="modal">Appointment Search</a>
            </div>
